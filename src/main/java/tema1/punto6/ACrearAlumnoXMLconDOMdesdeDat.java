   ...
   try{
	 ...
	 id=file.readInt(); // Se obtiene el identificador del alumno	  	  
       for (int i = 0; i < apellido.length; i++) {
         ...
         apellido[i] = aux;        }  // Los caracteres del apellido se guardan en un vector
     ...
     Result result = new StreamResult(new java.io.File("C:\\Users\\Antonio\\Documents\\NetBeansProjects\\Ficheros\\Prueba\\Alumnos.xml"));  // Nombre del fichero XML      
